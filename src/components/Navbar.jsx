...
import { FiShoppingBag, FiChevronDown, FiUser, FiLogOut, FiGrid, FiBox } from "react-icons/fi";
  ...
  return (
    <nav className="w-full bg-gradient-to-r from-blue-400 via-blue-300 to-blue-200 shadow z-50">
      <div className="max-w-7xl mx-auto px-4 flex items-center h-16">
        ...
        <Link
          to="/"
          className="font-bold text-2xl text-[#023047] tracking-wide whitespace-nowrap mr-6"
          onClick={() => {
        ...
        {/* Search Bar - Center (sirf jab category selected ho tab dikhana) */}
        {selectedCategory && (
        ...
        {!selectedCategory && <div className="flex-1"></div>}
        ...
        <div className="flex items-center gap-6 ml-6">
          ...
          {/* Your Boxes (About ke left me) */}
          <Link to="/your-boxes" className="font-medium text-[#023047] hover:text-[#1769aa]">
            Your Boxes
          </Link>
          {/* About (Contact ke left me) */}
          <Link to="/about" className="font-medium text-[#023047] hover:text-[#1769aa]">
            About
          </Link>
          {/* Contact */}
          <Link to="/contact" className="font-medium text-[#023047] hover:text-[#1769aa]">
            Contact
          </Link>
          {/* User/Login */}
          {user ? (
